...
void grilled_sausage(int batch)
{
        ...
        printf(" <p>Fleisch: %d</p>\n", meat * batch);
        printf(" <p>Zwiebel: %d</p>\n", onion * batch);
        printf(" <p>Pfeffer: %d</p>\n", pepper * batch);
        printf(" <p>Salz: %d</p>\n", salt * batch);
}
...
void stir_fried_seafood(int batch)
{
        ...
        printf(" <p>Meerersfrüchte: %d</p>\n", seafood * batch);
        printf(" <p>Gemüse: %d</p>\n", vegetables * batch);
        printf(" <p>Weiße Soße: %d</p>\n", white_sauce * batch);
        printf(" <p>Peperoni: %d</p>\n", hot_pepper * batch);
}
...
void cheese_gratin(int batch)
{
        ...
        printf(" <p>Grillwurst: %d</p>\n", grilled_sausage * batch);
        printf(" <p>Teig: %d</p>\n", dough * batch);
        printf(" <p>Gemüse: %d</p>\n", vegetables * batch);
        printf(" <p>Käse: %d</p>\n", cheese * batch);
        printf(" <p>Rote Soße: %d</p>\n", red_sauce * batch);
}
...
void fish_fillet_chip(int batch)
{
        ...
        printf(" <p>Getrockneter Fisch: %d</p>\n", dried_fish * batch);
        printf(" <p>Weiße Soße: %d</p>\n", white_sauce * batch);
        printf(" <p>Mehl: %d</p>\n", flour * batch);
        printf(" <p>Salz: %d</p>\n", salt * batch);
}
...
void fruit_wine(int batch)
{
        ...
        printf(" <p>Exotischer Kräuterwein: %d</p>\n", exotic_herbal_wine * batch);
        printf(" <p>Früchte: %d</p>\n", fruit * batch);
        printf(" <p>Liköressenz: %d</p>\n", essence_liquor * batch);
        printf(" <p>Mineralwasser: %d</p>\n", min_water * batch);
}
...
void hq_carrot_juice(int batch)
{
        ...
        printf(" <p>Hochwerte Karroten: %d</p>\n", hq_carrot * batch);
        printf(" <p>Mehl: %d</p>\n", flour * batch);
        printf(" <p>Zucker: %d</p>\n", sugar * batch);
        printf(" <p>Mineralwasser: %d</p>\n", min_water * batch);
}
...
void organic_feed_a(int batch)
{
        ...
        printf(" <p>Haferbrei: %d</p>\n", oatmeal * batch);
        printf(" <p>Fleisch: %d</p>\n", meat * batch);
        printf(" <p>Hühnchenfleisch: %d</p>\n", bird_meat * batch);
        printf(" <p>Fisch #1: %d</p>\n", fish_a * batch);
        printf(" <p>Fisch #2: %d</p>\n", fish_b * batch);
}
...
void special_carrot_juice(int batch)
{
        ...
        printf(" <p>Besondere Karotte: %d</p>\n", special_carrot * batch);
        printf(" <p>Mehl: %d</p>\n", flour * batch);
        printf(" <p>Zucker: %d</p>\n", sugar * batch);
        printf(" <p>Mineralwasser: %d</p>\n", min_water * batch);
}
...
void balenos_special(int batch)
{
        ...
        printf(" <p>Käsegratin: %d</p>\n", cheese_gratin * batch);
        printf(" <p>Fleischkrokette: %d</p>\n", meat_croquette * batch);
        printf(" <p>Räucherfischsteak: %d</p>\n", smoked_fish_steak * batch);
        printf(" <p>Gemüsepfanne: %d</p>\n", stir_fried_vegetables * batch);
        printf(" <p>Bier: %d</p>\n", beer * batch);
}
...
void calpheon_special(int batch)
{
        ...
        printf(" <p>Milchbrot: %d</p>\n", soft_bread * batch);
        printf(" <p>Milchtee: %d</p>\n", milk_tea * batch);
        printf(" <p>Fischfiletsalat: %d</p>\n", fish_fillet_salad * batch);
        printf(" <p>Käsekuchen: %d</p>\n", cheese_pie * batch);
        printf(" <p>Fleischpasta: %d</p>\n", meat_pasta * batch);
}
...
void dark_pudding(int batch)
{
        ...
        printf(" <p>Haferbrei: %d</p>\n", oatmeal * batch);
        printf(" <p>Eingelegtes Gemüse: %d</p>\n", pickled_vegetables * batch);
        printf(" <p>Hünchenfleisch: %d</p>\n", bird_meat * batch);
        printf(" <p>Braunes Blut: %d</p>\n", deer_blood * batch);
}
